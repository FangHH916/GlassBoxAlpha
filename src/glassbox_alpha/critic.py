    ...
    def review(self, proposal: TradeProposal, features: MarketFeatures) -> CriticVerdict:
        ...
        payload = {
            ...
            "instructions": (
                ...
                "The candidate's exact strategy name and all strategy scores are supplied in features. "
                "trend-pullback expects medium-trend alignment with countertrend momentum/RSI. "
                "volatility-expansion expects elevated short/long realized-volatility ratio plus a directional "
                "20-bar breakout. momentum-breakout follows aligned trend/momentum; mean-reversion fades "
                "short momentum and extended RSI. Judge only the selected strategy; "
